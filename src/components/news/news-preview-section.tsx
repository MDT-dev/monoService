...
export default function NewsPreviewSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-48 h-48 bg-[#1F8A70] rounded-br-full opacity-30 z-0" />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 text-center lg:text-left">
          ...
          <div className="lg:w-2/3 space-y-6">
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-6 py-3 bg-white rounded-full text-[#1F8A70] font-medium border border-green-200 shadow-md"
            >
              <Newspaper size={20} />
            ...
            <motion.div variants={itemVariants}>
              <Link href="/noticias" passHref>
                <Button
                  size="lg"
                  className="bg-[#1F8A70] hover:bg-green-700 text-white px-8 py-4 text-lg rounded-full shadow-lg group"
                >
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-8 right-8 w-16 h-16 bg-[#1F8A70] rounded-full opacity-40" />
            </motion.div>
          </motion.div>
        </div>
      </div>
